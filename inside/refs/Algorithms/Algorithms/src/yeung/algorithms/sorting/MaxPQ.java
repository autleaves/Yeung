...
public class MaxPQ<Key> implements Iterable<Key> {
    ...
    ***************************************************************************/
    ...
    private void swim(int k) {
    	StdOut.print("Before swim,PQ contains These keys: ");
    	for(Key x : pq)
    	{
    		StdOut.print(x + " ");
    	}
        ...
        StdOut.print("After swim,PQ contains These keys: ");
    	for(Key x : pq)
    	{
    		StdOut.print(x + " ");
    	}
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        while (!StdIn.isEmpty()) {
            ...
            {
            	pq.insert(item);
            	StdOut.printf("Inserted: " + item + ". ");
            	StdOut.print("Insert,PQ contains These keys: ");
            	for(String x : pq)
            	{
            		StdOut.print(x + " ");
            	}
            ...
            {
            	StdOut.print("Before delMax,These keys inside PQ: ");
            	for(String x : pq)
            	{
            		StdOut.print(x + " ");
            	}
            	StdOut.print("\nDeleted: "+pq.delMax() + ". ");
            	StdOut.print("\nAfter delMax,These keys keep in PQ: ");
            	for(String x : pq)
            	{
            		StdOut.print(x + " ");
            	}
